...
class Configuration():
    ...
    def __init__(self):
        self.size = (480, 700)
        self.caption = 'Draw multiple lines with the mouse'
    ...
    while True:
        for event in pygame.event.get():
            ...
            if event.type == pygame.QUIT:
                ...
                temp_line_coordinate = configs.start, configs.end
                configs.lines.append(temp_line_coordinate)
        ...
        for line in configs.lines:
            pygame.draw.line(screen, configs.line_color, line[0], line[1], configs.line_width)
