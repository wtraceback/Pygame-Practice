...
class Configuration():
    ...
    def __init__(self):
        self.size = (480, 700)
        self.caption = 'Draw multiple rectangle with the mouse'
    ...
    while True:
        for event in pygame.event.get():
            ...
            if event.type == pygame.QUIT:
                ...
                temp_rect = (configs.start, configs.rect_size)
                configs.rect_list.append(temp_rect)
        ...
        # 绘制已经结束的矩形
        for rect in configs.rect_list:
            pygame.draw.rect(screen, configs.rect_color, rect, configs.border_width)
